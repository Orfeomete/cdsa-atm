"""
PPO Actor-Critic for CDSA-ATM — NumPy reference implementation (v2).
...
three-ANSP consortium simulation. Framework-scale training is planned
under TUBITAK 1001 ARDEB Project 4 (Faz B).
"""
