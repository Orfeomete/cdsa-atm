"""
FedAvg aggregator for CDSA-ATM — NumPy reference implementation (v2).

Reference: McMahan, B. et al. (2017). Communication-Efficient Learning
of Deep Networks from Decentralized Data. AISTATS.

Data-weighted Federated Averaging over parameter dictionaries for the
ANSP consortium (DHMI, DFS, ENAIRE), with an optional Laplace
differential-privacy hook applied to client updates before aggregation.
