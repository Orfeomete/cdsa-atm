"""
LIME local explanations for CDSA-ATM — NumPy reference implementation (v2).

Reference: Ribeiro, Singh & Guestrin (2016), ACM KDD.

Locally weighted ridge-regression surrogate via Gaussian perturbation,
yielding per-feature local importance for one action class.
"""
